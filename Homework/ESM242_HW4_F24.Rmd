...
out_2a2=nloptr(x0=35,
               ...
               discount=0.05,
               int_state=948.2253)
round(out_2a2$solution)
-out_2a2$objective

out_2a3=nloptr(x0=35,
               eval_f=opt_fct,
               opts=options,
               lb=0,
               eval_g_eq = constraint,
...
```{r}
# This is not correct but getting there 
df2b1 <- table_function(round(out_2a1$solutio), c=3.178025)
knitr::kable(df2b1, align='c')
df2b2 <- table_function(round(out_2a2$solution), int_state=948.2253)
knitr::kable(df2b2, align='c')
df2b3 <- table_function(round(out_2a3$solution), b=0.75194)
